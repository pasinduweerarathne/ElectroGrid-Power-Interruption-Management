...
import com.PowerInterruptionManagement;
 ...
 */
@WebServlet("/PowerInterruptionManagmentAPI")
public class PowerInterruptionManagementAPI extends HttpServlet {
	 ...
	 */
	public PowerInterruptionManagementAPI() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String output = projectObj.insertProject(request.getParameter("id"), 
